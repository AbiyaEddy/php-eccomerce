                    ...
                    <figure class="card card-product">
                        ...
                        <div class="bottom-wrap">
                            ...
                            <div class="price-wrap h5">
                                ...
                                <div>
                                    <button class="btn btn-primary addToCartBtn reload "  value="<?= $prodresults->id ?>">Add to Cart</button>
                    ...
                    <figure class="card card-product">
                        ...
                        <div class="bottom-wrap">
                            <div class="price-wrap h5">
                                ...
                                <div>
                                    <button class="btn btn-primary addToCartBtn reload"  value="<?= $prodrecent->id; ?>">Add to Cart</button>
